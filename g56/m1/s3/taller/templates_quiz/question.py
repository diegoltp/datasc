...
def choose_q(dificultad):
    """
    [Selecciona la pregunta y alternativas asociadas a la dificultad sin que se repitan]
    Args:
    dificultad ([str]): [nivel de dificultad]
    Returns:
    [list]: [enunciado de la pregunta]
...
if __name__ == '__main__':
    ...
    """
    x=[1,2,3]
    print(p.pool_preguntas["intermedias"][f"pregunta_{random.choice(x)}"]["enunciado"])
    y=p.pool_preguntas["intermedias"]
    print(y["pregunta_1"])
    """